          ...
          <div className="z-100 2xl:pt-[180px] lg:pt-[160px] pt-[80px] 2xl:pb-[65px] pb-[50px] text-white ">
                ...
                <div className="md:flex gap-10 text-center justify-evenly items-center">
                  ...
                  <div className="mr-10 lg:mr-24">
                    ...
                    At Book-Berry, we share the same passion for taking on challenges and creating new possibilities in the world of literature.
                    </p>
                  </div>
                ...
                <div className="flex justify-center items-center text-center">
                  <div className=" ">
                    <div>
                      <p>
                        {" "}
                        © All Copyright 2024 by <span className="font-mono text-base md:text-lg">BookBerry</span>
                      </p>
                    </div>
